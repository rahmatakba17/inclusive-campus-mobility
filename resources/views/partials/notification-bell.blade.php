...
<div x-data="notificationPanel()" x-init="init()" class="relative" id="notif-wrapper-{{ $variant }}">
    ...
    <div x-show="open"
        ...
        {{-- ── Loading state ── --}}
        <div :class="{ 'hidden': !loading }" class="flex-col items-center justify-center py-12 gap-3 flex">
        ...
        {{-- ── Empty state ── --}}
        <div :class="{ 'hidden': loading || notifications.length > 0 }"
             class="flex-col items-center py-14 px-6 text-center flex">
                   ...
                   x-transition:enter-end="opacity-100 translate-x-0">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-start justify-between gap-1 mb-0.5">
                            ...
                            <span :class="{ 'hidden': !notif.unread }"
        ...
        {{-- ── Footer ── --}}
        <div :class="{ 'hidden': loading || notifications.length === 0 }"
             class="px-5 py-3.5 bg-gradient-to-r from-slate-50 to-white border-t border-slate-100 items-center justify-between flex">
            <div class="flex items-center gap-2">

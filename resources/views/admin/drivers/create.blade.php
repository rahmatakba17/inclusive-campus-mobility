...
<div class="max-w-2xl bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
    <div class="px-12 py-10 border-b border-slate-50 bg-slate-50/20">
        ...
        <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-1.5">{{ __('Tambah data akun pengemudi baru') }}</p>
    </div>
    ...
    <form action="{{ route('admin.drivers.store') }}" method="POST" class="p-10 space-y-6">
        ...
        <div>
            <label class="block text-xs font-black text-slate-400 tracking-widest uppercase mb-2">Password</label>
        ...
        <div>
            <label class="block text-xs font-black text-slate-400 tracking-widest uppercase mb-2">Konfirmasi Password</label>

        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden animate-slide-up border border-white/20">
            ...
            <div class="p-8">
                ...
                <div class="text-center mb-6">
                    ...
                    <p class="text-gray-500 mt-2 text-sm leading-relaxed">Bergabunglah dengan Bus Kampus Non-Merdeka<br>dan pantau perjalanan Anda secara real-time.</p>
                </div>
                ...
                <div class="mb-6 bg-blue-50 border border-blue-200 rounded-2xl p-4 flex gap-4 animate-fade-in shadow-sm transform transition hover:-translate-y-1 hover:shadow-md">
                    ...
                    <div>
                        <h4 class="font-bold text-blue-800 text-sm mb-1">Informasi Tipe Akun</h4>
                        <div class="text-xs text-blue-700 space-y-1.5">
                            <p class="flex items-start gap-1.5">
                                <i class="fas fa-check-circle text-blue-500 mt-0.5"></i>
                                <span>Gunakan email <strong class="bg-blue-100 px-1 rounded">@kampus-non-merdeka.ac.id</strong> untuk mendaftar sebagai <strong>Civitas Akademika</strong> (Gratis).</span>
                            </p>
                            <p class="flex items-start gap-1.5">
                                <i class="fas fa-check-circle text-blue-500 mt-0.5"></i>
                                <span>Email selain itu akan terdaftar sebagai akun <strong>Umum</strong> (Fitur E-Payment).</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ route('register') }}" method="POST" class="space-y-5 relative">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-1.5 ml-1">Konfirmasi Sandi</label>
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <div class="bg-gray-50/80 border-t border-gray-100 py-5 text-center transition-colors hover:bg-gray-100/80 rounded-b-3xl">
                <p class="text-gray-500 text-sm">Sudah punya akun?
                    <a href="{{ route('login') }}" class="text-red-600 font-bold hover:text-red-800 transition-colors ml-1 hover:underline decoration-2 underline-offset-4">Masuk di sini</a>
                </p>
            </div>
        </div>
    </div>
